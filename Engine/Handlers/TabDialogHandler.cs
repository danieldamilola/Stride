...
public static class TabDialogHandler
{
    ...
    {
        var host = Uri.TryCreate(e.Uri, UriKind.Absolute, out var uri) ? uri.Host : "";
    ...
    private static void ShowPermissionDialog(CoreWebView2PermissionRequestedEventArgs e)
    {
        var host = Uri.TryCreate(e.Uri, UriKind.Absolute, out var uri) ? uri.Host : "";
